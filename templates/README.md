...
[демо запуска редактора standalone](https://cdn.rawgit.com/forceuser/emote-wysiwyg/{{version}}/index.html)

[демо запуска с лаунчером](https://cdn.rawgit.com/forceuser/emote-wysiwyg/{{version}}/launcher.html)
